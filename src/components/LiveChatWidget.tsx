      ...
      <AnimatePresence mode="wait">
        ...
        {!isOpen ? (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="relative h-14 w-14 rounded-full bg-slate-900 hover:bg-slate-800 text-white flex items-center justify-center shadow-lg cursor-pointer border border-slate-200"
          ...
          <motion.div
            ...
            className="w-80 sm:w-96 h-[500px] bg-white border border-slate-200 rounded-2xl shadow-2xl flex flex-col overflow-hidden"
            id="chat-expanded-console"
          >
            {/* Header */}
